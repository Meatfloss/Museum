(function () {
  ...
  angular
    .module('snuff')
    .controller('SnuffListController', SnuffListController);

  SnuffListController.$inject = ['$filter', 'SnuffService', 'authorsResolve'];

  function SnuffListController($filter, SnuffService, authors) {
    var vm = this;
    vm.buildPager = buildPager;
    vm.figureOutItemsToDisplay = figureOutItemsToDisplay;
    vm.pageChanged = pageChanged;

    SnuffService.query(function (data) {
      vm.snuff = data;
      vm.buildPager();
    });
    ...
    function figureOutItemsToDisplay() {
      vm.filteredItems = $filter('filter')(vm.snuff, { $: vm.search });
