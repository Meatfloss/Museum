(function () {
  ...
  YporcelainsListController.$inject = ['$filter', 'YporcelainsService'];

  function YporcelainsListController($filter, YporcelainsService) {
    var vm = this;
    vm.buildPager = buildPager;
    vm.figureOutItemsToDisplay = figureOutItemsToDisplay;
    vm.pageChanged = pageChanged;

    YporcelainsService.query(function (data) {
      vm.yporcelains = data;
      vm.buildPager();
      // update dropdown list
      vm.dynastyList = _.map(_.uniqBy(vm.yporcelains, 'dynasty'), 'dynasty');
