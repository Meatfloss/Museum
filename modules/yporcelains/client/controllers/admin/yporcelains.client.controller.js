(function () {
  ...
  angular
    ...
    .controller('YporcelainsAdminController', YporcelainsController);

  YporcelainsController.$inject = ['$scope', '$timeout', '$state', '$window', 'yporcelainsResolve', 'dynastyResolve', 'Authentication', 'FileUploader'];

  function YporcelainsController($scope, $timeout, $state, $window, yporcelains, dynasties, Authentication, FileUploader) {
    var vm = this;
    ...
    var dynasty = _.find(dynasties, { 'name': vm.yporcelains.dynasty });
    if (dynasty) {
    ...
    function updateDynasty(dynasty) {
      vm.categories = _.find(dynasties, { 'name': vm.yporcelains.dynasty }).categories;
    }
