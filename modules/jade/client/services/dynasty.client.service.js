(function () {
  ...
  function DynastyService($resource) {
    ...
    var dynasty7 = { name: 'Tang / Five Dynasties', show: false, categories: ['Yue Yao', 'Mise Porcelain', 'Changsha Yao', 'Jiaxian Yao', 'Marbled Porcelain', 'Tongguan Yao', 'Xing Yao', 'Ding Yao', 'Chai Yao'] };
