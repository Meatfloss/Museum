(function () {
  ...
  CurrencyListController.$inject = ['$filter', 'CurrencyService'];

  function CurrencyListController($filter, CurrencyService) {
    var vm = this;
    vm.buildPager = buildPager;
    vm.figureOutItemsToDisplay = figureOutItemsToDisplay;
    vm.pageChanged = pageChanged;

    CurrencyService.query(function (data) {
      vm.currency = data;
      vm.buildPager();
      // update dropdown list
      vm.dynastyList = _.map(_.uniqBy(vm.currency, 'dynasty'), 'dynasty');
    ...
    function figureOutItemsToDisplay() {
      vm.filteredItems = $filter('filter')(vm.currency, { $: vm.search });
