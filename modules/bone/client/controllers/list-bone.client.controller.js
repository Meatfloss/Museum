(function () {
  ...
  angular
    .module('bone')
    .controller('BoneListController', BoneListController);

  BoneListController.$inject = ['$filter', 'BoneService', 'authorsResolve'];

  function BoneListController($filter, BoneService, authors) {
    var vm = this;
    vm.buildPager = buildPager;
    vm.figureOutItemsToDisplay = figureOutItemsToDisplay;
    vm.pageChanged = pageChanged;

    BoneService.query(function (data) {
      vm.bone = data;
      vm.buildPager();
    });
    ...
    function figureOutItemsToDisplay() {
      vm.filteredItems = $filter('filter')(vm.bone, { $: vm.search });
