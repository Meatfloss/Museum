(function () {
  ...
  CrystalListController.$inject = ['$filter', 'CrystalService'];

  function CrystalListController($filter, CrystalService) {
    var vm = this;
    ...
    CrystalService.query(function (data) {
      ...
      vm.dynastyList = _.map(_.uniqBy(vm.crystal, 'dynasty'), 'dynasty');
